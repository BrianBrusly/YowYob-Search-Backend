...
* [Spring Data Elasticsearch](https://docs.spring.io/spring-boot/3.5.8-SNAPSHOT/reference/data/nosql.html#data.nosql.elasticsearch)
...
* [Flyway Migration](https://docs.spring.io/spring-boot/3.5.8-SNAPSHOT/how-to/data-initialization.html#howto.data-initialization.migration-tool.flyway)
...
* [Quartz Scheduler](https://docs.spring.io/spring-boot/3.5.8-SNAPSHOT/reference/io/quartz.html)
* [Java Mail Sender](https://docs.spring.io/spring-boot/3.5.8-SNAPSHOT/reference/io/email.html)
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.5.8-SNAPSHOT/reference/messaging/kafka.html)
